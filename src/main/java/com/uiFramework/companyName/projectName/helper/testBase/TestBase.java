...
import com.uiFramework.companyName.projectName.helper.browserConfig.config.PropertyReader;
...
public class TestBase {
	...
	public void beforeSuite() {
		/*
		 * get the instance of ExtentReports from the ExtentManager class. It will run for just 1 time.
		 */
	...
	{
		/*
		 * Create a test with the classname. Classname here is for which you are running the test
		 */
	...
	public void BeforeTest() {
		/*
		 * called before all of your test in the class. ObjectReader.reader is a reference of ConfigReader interface.
		 */
	...
	{
		/*
		 * A Method provides information about, and access to, a single method on a class or interface. Before every method
		 * it will execute and print this log "XYX method is started"
		 */
	...
	/*
	 * After test execution, we have pass and fail report for that method. log that thing with customized message
	 * getThrowable()- print the exception in the logs/report 
	 */
	...
	public void afterMethod(ITestResult result)
	{
		if(result.getStatus()==ITestResult.FAILURE) {
			...
			/*
			 * Will attach the screenshot of window with the test. Also its need to run on the class which launch the browser.
			 */
	...
	public WebDriver getBroswerType(BrowserType btype) {
		try {
			...
			case Firefox:
				...
				firefox.getFirefoxDriver(firefoxOptions);
			default:
	 ...
	 * You will not write this code everywhere, this method will help you to do the same task for you
	 */
